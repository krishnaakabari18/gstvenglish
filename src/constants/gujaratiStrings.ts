...
export const RASHIFAL_PAGE = {
  ...
  LOADING: 'Horoscope is loading...',
  HOME: 'Home',
  RASHIFAL: 'Horoscope',
  RASHIFAL_TITLE: 'Horoscope',
  LOADING_DETAIL: 'Loading zodiac details...',
  LOAD_ERROR: 'An error occurred while loading the horoscope.',
  BACK_TO_RASHIFAL: '← Back to Horoscope',
  TODAY_RASHIFAL: 'Today\'s {rashi} Horoscope',
  SELECT_RASHI: 'Select Zodiac Sign',
  NAME_STARTS_WITH: '(Name starts with {word})',
  NO_INFO_AVAILABLE: 'Zodiac information is not available.',
  SATURDAY: 'Saturday',
  SUNDAY: 'Sunday',
  MONDAY: 'Monday',
  TUESDAY: 'Tuesday',
...
export const MAGAZINE_PAGE = {
  ...
  LOADING_ERROR_GUJ: 'Error loading magazine. Please try again.',
  LOADING_MESSAGE_GUJ: 'Loading magazine...',
  NO_MAGAZINE_FOUND: 'No magazines found.',
  ALL_MAGAZINES_LOADED: 'All magazines have been loaded.',
  NOT_AVAILABLE_FOR_DATE: 'Magazine is not available for this date.',
  MAGAZINE_REVIEW: 'Magazine Review',
  SELECT_MAGAZINE: 'Select Magazine',
  PLEASE_SELECT_MAGAZINE: 'Please select a magazine.',
  LOADING_MAGAZINE_ERROR: 'Error loading magazine:',
} as const;
