...
! function() {
    ...
    function n(a) {
        a.ui.registry.addButton("quickimage", {
            ...
            onAction: function() {
                $('#imagevideoModalCenter').modal('show');
                $('#hiddenimage').val(1);
                // var i = a;
                // new s(function(n) {
    ...
    var u, c = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        l = 0,
    ...
    c.add("quickbars", function(t) {
        var o, e;
        n(t), 0 < (e = x(o = t, "quickbars_insert_toolbar", "quickimage quicktable openmedia")).trim().length && o.ui.registry.addContextToolbar("quickblock", {
