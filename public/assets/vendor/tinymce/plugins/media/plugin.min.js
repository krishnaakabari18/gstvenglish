...
! function() {
    ...
    function y(i, e) {
        ...
        return V({
            ...
            start: function(e, t) {
                if (!c.get())
                    if (J(t.map, "data-ephox-embed-iri")) c.set(!0), o = (a = (n = t).map.style) ? X.parseStyle(a) : {}, s = {
    ...
    function S(e, c, s) {
        ...
        return V({
            ...
            start: function(e, t, r) {
                if (!m.get())
                    if (J(t.map, "data-ephox-embed-iri")) m.set(!0), n = c, (i = (o = (a = t).map.style) ? ee.parseStyle(o) : {})["max-width"] = j(n.width), i["max-height"] = j(n.height), O(a, {
                ...
                if (!m.get()) {
                    if ("video" === e && s)
                        for (var t, r = 0; r < 2; r++) c[te[r]] && ((t = []).map = {}, d <= r && (O(t, {
                            src: c[te[r]],
                            type: c[te[r] + "mime"]
                        }), l.start("source", t, !0)));
                    var n;
    ...
    function _(e, t) {
        for (var r, n = (r = t.match(/^(https?:\/\/|www\.)(.+)$/i)) && 1 < r.length && "www." !== r[1] ? r[1] : "https://", a = e.regex.exec(t), o = n + e.url, i = 0; i < a.length; i++) ! function(e) {
    ...
    function k(r, e) {
        ...
        var t, a, o = (t = n.source, 0 < (a = re.filter(function(e) {
    ...
    function D(e, t) {
        ...
        return p(p(p(p(p({}, s("source")), s("altsource")), s("poster")), s("embed")), (r = a, n = {}, g(e, "dimensions").each(function(e) {
    ...
    function F(a, o) {
        return function(e) {
            var t, r, n;
            i(e.url) && 0 < e.url.trim().length && (t = e.html, r = M(o, t), n = p(p({}, r), {
                source: e.url,
                embed: t
            }), a.setData(P(n)))
        }
        ...
        var h = m.windowManager.open({
            ...
            onChange: function(e, t) {
                switch (t.name) {
                    ...
                    case "altsource":
                    case "poster":
                        n = t.name, a = D((r = e).getData(), n), o = k(m, a), r.setData(P(p(p({}, a), {
                            embed: o
                        })))
                }
    ...
    function L(e, t) {
        ...
        var a, o = e.dom.parseStyle(t.attr("style")),
            i = new oe(r, 1);
        R(t, i, o), i.attr({
            src: t.attr("src"),
            style: t.attr("style"),
            ...
            for (var a = ce({
                    ...
                    context: t
                }); a.firstChild;) r.append(a.firstChild)
        }(e, r, i, unescape(a)));
        var c = new oe("span", 1);
